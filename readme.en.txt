Shogunate Map alteration MOD alpha Version 0.4.3 'Atoiya'
...
Shogunate Map alteration sub MOD alpha version Version 0.4.3 'Atoiya' is a submod of the Shogunate mod. It replaces map with a high-resolution one and increases the Provence-Baron territory.
...
[list]
[*] The navigable rivers that existed in the main mod are no longer present.
[*] There are no special map objects such as mines.
[*] Some Provinces exist in isolation.
[*] Surround map does not exist.
[*] Historically accurate names for barony title names and county title names have not yet been established.
[*] Provins too small.
[*] There is a provience that is not linked to the title.
[*] The lake is dried up with no map objects in place.
[*] There is a lake Provinces that is better off as an ocean than a non-navigable lake.
[*] No map locator, duplicate locator locations.
[*] The newly added county historical data is just a copy of the connected existing historical data.
[*] The Shogunate mod doesn't cover all the information about changing baronial title names depending on age.
[*] The ground texture displayed on the map is different from the historical one.
[*] The winter function added in CK3 version 1.3 will not work.
[*] Person's hairstyle. Clothing is from vanilla Step-Mongolian culture. Due to the author's unfamiliarity with 3D CG modeling, there are no plans to implement Japanese hairstyles or clothing.
[/list]
...
[*] 3D modeling of character hair and clothes in Maya or Blender, exporting them in PDX format, and adjusting them so that they work in-game.
[/olist]
