Shogunate Map alteration MOD alpha Version 0.4.2 'Atoiya'

[h1]※ This is a public upload test, so it will unexpectedly become private[/h1]
[h1]Shogunate MOD Map alteration sub MOD alpha version Version 0.4.2 'Atoiya'[/h1]
====

Shogunate Map alteration sub MOD alpha version Version 0.4.2 'Atoiya' is a submod of the Shogunate mod. It replaces map with a high-resolution one and increases the Provence-Baron territory.
...
[list]
[*] There are no rivers that can or cannot be traversed.
[*] There are no special map objects such as mines.
[*] Some Provinces exist in isolation.
[*] Surround map does not exist.
[*] Language data for baronial title names and county title names is not yet set.
...
[*] Baronial titles are duplicated before and after the name suffix.
...
[*] Barony title name history data in Shogunate MOD will not be reflected.
[*] The ground texture displayed on the map is different from the historical one.
[*] The number of valid bookmarks has been tentatively reduced from the main mod because the Barony title names have been researched and set to 12th century standards.
[/list]
