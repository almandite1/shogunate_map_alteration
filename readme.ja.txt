Shogunate 地図改変サブ MOD 日本語 アルファ版 Version 0.4.6 'Atoiya'

[h1]※ アップロードテストのための公開なので予告なく非公開になります[/h1]
[h1]Shogunate 地図改変サブ MOD 日本語 アルファ版 Version 0.4.6 'Atoiya'[/h1]
====

Shogunate 地図改変サブ MOD アルファ版 Version 0.4.6 'Atoiya'は [url=https://steamcommunity.com/workshop/filedetails/?id=2253279956]Shogunate MOD [/url]のサブ MOD です。地図を高解像なものに置き換え、プロヴィンス＝男爵領を増やします。
...
[*] マップロケーターがないプロヴィンスがある。マップロケーターの位置が重複している。
[*] 新しく追加した伯爵領歴史データは連接する既存歴史データをコピーしただけのものです。
[*] Shogunate MOD にはある、年代によって男爵領タイトル名変更される情報はすべて網羅されていません。
...
[h2]動作条件[/h2]
[list]
[*] [url=https://store.steampowered.com/app/1158310]Crusader Kings III　バージョン 1.3[/url]
...
[olist]
[*] 男爵領のタイトル名が歴史的に適切であるかどうか確認すること。
[*] マップエディターを使って、マップロケーターの位置を適切な場所に調整すること。
[*] マップエディターを使って、木のマップオブジェクトを配置すること。
[*] タイトル名やこの Steam Workshop　のコンテンツを英語、フランス語、ドイツ語、韓国語、ロシア語、中国語（簡体字）、スペイン語その他の言語への翻訳。
[*] キャラクターの髪や服を Maya や Blender　で 3D モデリングし、PDX形式でエクスポートし、ゲーム内で動くように調整すること。
[/olist]
